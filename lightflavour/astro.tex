...
%
where, for CR studies, the $B_2$ and $B_3$ values should be read from the \todo{Stefano P: you should quantify ``the lowest $p_{\mathrm{T}}$ bin''}lowest $p_{\mathrm{T}}$ bin in the accelerator analysis. 
%
