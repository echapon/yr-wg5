...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.6\columnwidth]{quarkonia/fig/in-med-pot.pdf}
\end{center}
\vspace{-0.5cm}
...
\begin{center}
 \includegraphics[width=0.66\textwidth]{quarkonia/fig/alice/alice_jpsi_v2_projected.pdf}
 \includegraphics[width=0.32\textwidth]{quarkonia/fig/alice/alice_jpsi_v2_projected2.pdf}
\end{center}
...
\begin{figure}
\begin{center}
 \includegraphics[width=0.5\textwidth]{quarkonia/fig/atlas/atlas_promptjpsi_models}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[width=\textwidth]{quarkonia/fig/alice/jpsi_polarisation.png}
\end{center}
...
\begin{figure}
\begin{center}
 \includegraphics[width=0.32\textwidth]{quarkonia/fig/alice/alice_dr_psi_projected}
 \includegraphics[width=0.32\textwidth]{quarkonia/fig/alice/alice_dr_psi_projected2}
\end{center}
...
\begin{figure}
\begin{center}
 \includegraphics[width=0.32\textwidth]{quarkonia/fig/theory/psi_dr_vitev.png}
\end{center}
...
\begin{figure}
\begin{center}
 \includegraphics[width=0.32\textwidth]{quarkonia/fig/theory/chic.png}
\end{center}
...
means that good muon (or electron) momentum resolution is essential to their measurement, especially for excited states. CMS benefits from its stronger magnetic field, while
the addition of the MFT will also beneficial in improving the muon momentum resolution of the ALICE detector.

% Summary of Run1+Run2 results %FIXME one word about RHIC too, please check
...
level, for $\sqrtsnn = 5.02$\,TeV). In addition, the large suppression found for \PGUP{1S} in central collisions does not seem compatible with unmodified direct \PGUP{1S} production,
...
ratios. This will further improve the precision for \PGUP{1S} measurements, as well as enable differential $\PGUP{2S}+\PGUP{3S}$ measurements. The improvement of the mass resolution can bring
a further improvement in the experimental precision of the results. In addition, the ATLAS and CMS detectors will also undergo major upgrades between Runs 3 and 4, with an inner tracker
...
\begin{center}
 ...
 \includegraphics[width=0.32\textwidth]{quarkonia/fig/theory/rapp_raa_npart_ALICE.png}
\end{center}
...
\begin{figure}
 \begin{center}
  \includegraphics[width=0.32\textwidth]{quarkonia/fig/theory/rapp_dr_npart.png}
 \end{center}
...
is already found between models and data regarding this suppression. % and discuss details here
...
\begin{center}
 ...
 \includegraphics[width=0.32\textwidth]{quarkonia/fig/theory/rapp_raa_pt_ALICE.png}
 \includegraphics[width=0.32\textwidth]{quarkonia/fig/theory/strickland_rap.png}
\end{center}
...
\begin{figure}
\begin{center}
 \includegraphics[width=0.32\textwidth]{quarkonia/fig/theory/rapp_v2_1S.png}
 \includegraphics[width=0.32\textwidth]{quarkonia/fig/theory/rapp_v2_2S.png}
\end{center}
...
\begin{figure}
 \begin{center}
  \includegraphics[width=0.32\textwidth]{quarkonia/fig/alice/alice_jpsi_v2_projected.pdf}
  \includegraphics[width=0.32\textwidth]{quarkonia/fig/alice/alice_jpsi_v2_projected2.pdf}
 \end{center}
...
\begin{figure}
 \begin{center}
  \includegraphics[width=0.5\textwidth]{quarkonia/fig/theory/cgc_jpsi_nch.png}
 \end{center}
