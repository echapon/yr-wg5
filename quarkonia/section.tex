...
\end{center}
 ...
 \caption{Projected \raa for \PGUP{1S} and \PGUP{2S} expected from the ALICE (left) and CMS~\cite{CMS-PAS-FTR-18-024} (center) experiments, as a function of rapidity, with \unit[10]{nb}$^{-1}$ of \PbPb data.
 }
