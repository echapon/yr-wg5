...
This leads to a maximum in the \raa as a function of $\pt$, at around 10\UGeV for \PGUP{1S}. The current data is not precise enough to confirm or disfavour this feature, but Run~3+4 
...
\PGUP{1S} at high $\pt$. As can be seen in Fig.~\ref{fig:upsi_raa_pt}, it is expected that a measurement up to a $\pt$ of about 50\UGeV can be performed with the ATLAS and CMS detectors with
