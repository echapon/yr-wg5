...
\textbf{Contributors}: Mateusz Dyndal (DESY), Samira Hassani (Universit\'e Paris-Saclay), Mariola Klusek-Gawenda (NIP PAS, Krak\'ow), Laurent Schoeffel (Universit\'e Paris-Saclay), Peter Steinberg (BNL)
...
\textbf{Coordinators}: Hans Dembinski (MPI for Nuclear Physics, Heidelberg)
 \textbf{Contributors}: Tanguy Pierog (Karlsruhe Institute of Technology), Ralf Ulrich (Karlsruhe Institute of Technology)
