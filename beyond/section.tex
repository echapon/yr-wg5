...
\end{itemize}
Energy flow measurements separated by hadronic and electromagnetic energy deposit constrain both $\nmult$ and $\alpha$, and can be done further forward than direct measurements of charged tracks. Particle identification is not needed to constrain the overall hadron multiplicity, but measuring the spectra of pions, kaons, and protons separately is important to tune and test internal parameters of hadronic interaction models. In particular, the number of produced baryons was found to strongly affect the number of muons in air showers at ground, despite their small number compared to pions (TODO: ref).
