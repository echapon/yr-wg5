...
\textbf{Contributors}: L.~Apolinario (LIP Lisbon), N.~Armesto (University of Santiago de Compostela), J.~Jowett (CERN), G.~Milhano (LIP Lisbon and CERN), U.A.~Wiedemann (CERN)
...
\begin{table}[h]
\caption{Global properties measured in central Pb--Pb collisions (0--5\% centrality class) at $\sqrtsNN=2.76$~TeV and extrapolated to 5.5, 10.6 and 39~TeV. {\bf ADD Xe--Xe mult at 11.5 TeV, extrapolated from Acharya:2018hhy ? And ET estimated assuming that it scales with mult.}}
\small
\begin{center}
\begin{tabular}{lccccc}
\hline
Quantity & Pb--Pb 2.76~TeV & Pb--Pb 5.5~TeV & Pb--Pb 10.6~TeV & Xe--Xe 11.5~TeV & Pb--Pb 39~TeV \\
\hline
${\rm d}N_{\rm ch}/{\rm d}\eta$ at $\eta=0$ & 1600 & 2000 & 2400 & 1500  & 3600 \\
${\rm d}E_{\rm T}/{\rm d}\eta$ at $\eta=0$ & 1.7--2.0~TeV & 2.3--2.6~TeV & 3.1--3.4~TeV & $\approx 1.5$~TeV &  5.2--5.8~TeV \\
Homogeneity volume $$ & 5000~fm$^3$  & 6200~fm$^3$ & 7400~fm$^3$ & 4500~fm$^3$ & 11000~fm$^3$ \\
Decoupling time & 10~fm/$c$ &  11~fm/$c$ & 11.5~fm/$c$ & 10~fm/$c$ & 13~fm/$c$ \\
$\varepsilon$ at $\tau=1$~fm/$c$ & 12--13~GeV/fm$^3$  & 16--17~GeV/fm$^3$ & 22--24~GeV/fm$^3$ & $\approx 15$~GeV/fm$^3$ & 35--40~GeV/fm$^3$ \\
\hline
\end{tabular}
\end{center}
\label{tab:PbPb}
