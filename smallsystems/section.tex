...
\begin{center}
  ...
  \begin{tabular}{p{5.7cm}|p{3.6cm}|p{3.6cm}|p{3.6cm}| p{4cm} }
    ...
    Statistical model                                & $\gamma^{\rm GC}_s=1$, 10--30\%                  & $\gamma^{\rm GC}_s\approx1$, 20--40\%         & $\gamma^{\rm C}_s<1$, 20--40\% (for MB) & \cite{Floris:2014pta,Adam:2015vsf,ALICE:2017jyt} \el
