...
\caption{Left panel: \Npart and forward multiplicity of \OO (top panels) and \pPb collisions (bottom panels) from Glauber MC. 
Right panel: Estimated multiplicity distributions in the forward region in \OO and \pPb collisions.
...
This is demonstrated in Fig.~\ref{fig:smallsystems_oopot}, which compares the number of participants and multiplicities between \OO and \pPb collisions.
It is evident that while the highest multiplicities in \pPb collisions are only accessible in the tail of the distribution, similar multiplicities are already reached in \OO collisions in the plateau region as illustrated by the 20--40\% event class.
