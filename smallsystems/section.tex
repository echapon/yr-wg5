...
%    Thermal dileptons                                & \multicolumn{3}{c|}{not accessible with current detectors}                                                                       &  \el %\cite{Acharya:2018ohw}
    ...
    Jet quenching through \RAA                       & yes                                              & not observed                                  & not observed                  & \cite{Aamodt:2010jd,CMS:2012aa,Abelev:2012hxa,ALICE:2012ab,Aad:2014bxa,Adam:2015ewa,Aad:2015wga,Adam:2016jfp,Sirunyan:2016fcs,Acharya:2018qsh,Acharya:2018njl,ATLAS:2014cpa}\el
...
The discoveries made in recent years in small collision systems have challenged two paradigms impacting both the modelling of heavy-ion collisions, as well as the underlying event of elementary \pp collisions. While ample experimental evidence exists that certain features of large systems, like multi-particle correlations and strangeness enhancement, are a) present also in small systems, and b) can be seen as evidence for final-state interactions, no evidence has been found for other features equally related to final-state interactions, like energy loss.

In this chapter we have presented a HL-LHC small system experimental program, based on such \textit{known unknowns}. The presented program promises significant progress shown by the set of performance studies, ranging from largely non-flow suppressed high-order correlations, over measurement of strange-particle yields and thermal radiation, to energy-loss signals. It is, however, also clear that while more statistics can aide in constraining current models, new theoretical insights are needed for developing a unified picture of parton dynamics and particle production valid for both small and large systems. New observables for constraining such \textit{unknown unknowns} should be developed in parallel. This working group encourages both investment in the necessary theoretical development, and facilitation of collaboration between theorists and experimentalists. Through the remaining lifetime of LHC, the community can look forward to a deepened understanding of non-perturbative QCD and a universal description of small to large collision systems.
