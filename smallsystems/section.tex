...
%    Thermal dileptons                                & \multicolumn{3}{c|}{not accessible with current detectors}                                                                       &  \el %\cite{Acharya:2018ohw}
    ...
    Jet quenching through \RAA                       & yes                                              & not observed                                  & not observed                  & \cite{Aamodt:2010jd,CMS:2012aa,Abelev:2012hxa,ALICE:2012ab,Aad:2014bxa,Adam:2015ewa,Aad:2015wga,Adam:2016jfp,Sirunyan:2016fcs,Acharya:2018qsh}\el
...
\begin{figure}[t]
\centering
\includegraphics[width=0.6\linewidth]{\main/smallsystems/img/2018-10-21-2018-10-21-finalPlotsTemperatureComparison_pPb_FastSim_FitBG_noDCAcut_fitResults_study0}
...
\caption{Glauber MC calculations are presented for for \OO (top panels) and \pPb collisions (bottom panels). Shown are \Npart as a function of impact parameter (left panels) and forward multiplicity as a function of \Npart (right panels).}
...
\caption{Estimated multiplicity distributions in the forward region in \OO and \pPb collisions.
The \OO studies have been been performed for the 2018 beam configurations at $\sqrtsNN = \unit[6.37]{\UTeV}$, while the Run 3 configuration would yield $\sqrtsNN = \unit[7]{\UTeV}$, with the advantage that a large \pp reference data set already exists from earlier LHC running (2010--11).
}
...
A promising opportunity to study the emergence of collective phenomena further as well as the presence of possible parton energy loss in small collision systems, are collisions of smaller nuclei. In particular, collisions of Oxygen-16 are a very efficient way to investigate properties of low multiplicity~(peripheral) large \AOnA collision systems.
...
This is demonstrated in Fig.~\ref{fig:smallsystems_oo_glauber}, which shows the correlations between number of participants, multiplicities and impact parameter in \OO and \pPb collisions.
It is evident from Fig.~\ref{fig:smallsystems_oo_mult} that while the highest multiplicities in \pPb collisions are only accessible in the tail of the distribution, similar multiplicities are already reached in \OO collisions in the plateau region as illustrated by the 20--40\% event class.
