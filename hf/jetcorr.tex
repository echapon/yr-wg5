...
%The comparison between pp and p--Pb collisions provide information on shadowing and hadronic rescatterings. The knowledge gained from the heavy-flavour correlation studies in small systems is expected to be used to reduce the presently unavoidable uncertainties in the models for Pb--Pb collisions, providing a more consistent view of the interaction of heavy quarks with the QGP. 
\begin{figure}
\centering
\resizebox{0.5\textwidth}{!}{  \includegraphics{hf/figures/DDbar_LHCb_EPOSpp.png}}
