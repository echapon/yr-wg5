...
\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{hf/figures/Deltaphi_pp_inclusive.pdf}
\includegraphics[width=0.49\textwidth]{hf/figures/Deltaphi_pPb_inclusive.pdf}
\caption{ LHCb projection of the azimuthal $\PD \APD$ correlations in \pPb and in \pp collisions at $\sqrts=$ 8.8 $\UTeV$ for the integrated Run~3 and Run~4 luminosity. A detailed description of the experimental estimates can be found in Ref.~\cite{LHCb-CONF-2018-005}. \textcolor{blue}{to be done: compared with predictions from the EPOS3-HQ event generator.
}}
\label{fig:DD}
\end {figure}
