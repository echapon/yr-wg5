...
\include{thermalradiation/RealPhotons}
...
% The real photon part is commented out for the time being since the projection plot is not ready yet (MW)

%%-----------------------------------------------------------------------%
%\begin{figure}[htb]
%\centering
%\includegraphics[width=0.45\textwidth,clip]{\main/thermalradiation/figs/2018-May-06-DRNonFit_CombAndTheory_pPb5TeV.pdf}
...
%We use several NLO pQCD calculations: one using proton structure functions \cite{Jager:2002xm} and set of models accounting for nuclear PDF modifications \cite{Eskola:2016oht}. As one can see, accounting nuclear modifications of structure functions makes modest effect on the total direct photon yield. 
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.8\textwidth]{\main/thermalradiation/figs/2018-09-29-2018-09-29-finalPlotsTemperatureComparison_pPb_FastSim_FitBG_noDCAcut_fitResults_study0}
