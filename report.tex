co\documentclass[11pt,twoside,a4paper]{cernrep} 
...
\providecommand{\biblio}{\bibliographystyle{report}\clearpage\bibliography{\bibfiles}}  % *Modification: added `\main/` to specify relative file location.
