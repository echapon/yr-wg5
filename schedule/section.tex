...
\item {\bf Intermediate AA}, e.g.\,$L_{\rm int}^{\rm Ar-Ar}=3~{\rm pb}^{-1}$ (about 3 months) gives NN luminosity equivalent to Pb--Pb with $L_{\rm int} =75$--$250~\invnb$

\end{itemize}

Based on these requirements, the proposed updated running schedule is reported in the following table. The extended physics programme for Run-3 and Run-4 discussed in this report is achievable with a modest increase of the ``heavy-ion running time'' from 4 to 6 weeks per year in 2022 and 2027. 
...
\hline
Run-5 & Intermediate AA & 11 weeks & e.g.\,Ar--Ar $3~\invpb$ \\
     &  pp reference & 1 week & \\
\hline
\end{tabular}
\end{center}
