...
A short p--O collision run is of interest for cosmic-ray physics.
Special case of O used as carrier gas in ion source. 
Scheduled with rapid setup in LHC, not a full one-month run. 
Model of 2017 Xe run or 2012 p-Pb run. 
