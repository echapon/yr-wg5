...
%It is seen that in most central events the $v_2$ is larger in Xe+Xe, 
%  but with decreasing centrality, the ratio decreases and by the
%  15--20\% centrality interval becomes smaller than unity.
%This dependence is because of the interplay between geometry and
%  viscous effects.
%As Xe+Xe is a smaller system compared to Pb+Pb, the relative impact 
%  of event-by-event fluctuations in the initial geometry 
%  is more prominent, and leads to larger eccentricities,  which in turn
%  lead to larger \vn.
...
Additionally, there has been much work is studying long-range correlations
