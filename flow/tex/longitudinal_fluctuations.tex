\subsubsection{Longitudinal flow fluctuations}
...
This assumption is most clear in the event-plane and scalar-product methods
  ...
  and the orientation of the reconstructed particles are then measured 
  relative to these \psin~\cite{HION-2011-01,HION-2016-06}.
...
The ATLAS measurements of $r_{2|2;1}$ over the 0--2.5 $\eta$ range 
...
The projections are made by fitting the existing data with a linear 
  function for the 20--30\% centrality range and with a quadratic 
  function for the 0--5\% centrality range.
...
Thus precise measurement of these decorrelations should give
  a better understanding of the initial conditions along the 
  longitudinal direction and in the development of full three-dimensional 
  viscous hydrodynamic models.
These would in turn result in a more accurate estimation of $\eta/s$.
